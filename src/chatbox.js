...
export default class ChatBox extends React.Component {
  ...
  addComment(author, text, image) {
    ...
    API.addComment(author, text, image, (data) => {
      API.getComments((data) => {
        this.setState({comments: data.comments, addingNewComment: false, newComment: ""});
    });
    });
  }
              ...
              <div className="topItemsHolder">
                <div className="profileImageHolder">
                  ...
                  <div className="rightItems">
                    ...
                    <div className="likes">
                      <FavoriteBorderIcon sx={{"marginRight": "3px"}}/> {comment.likes}
                    </div>
                  </div>
              </div>
          ...
          <div className="chatCellHolder">
            ...
            <div className="addComment">
              ...
              />
                <SendIcon
                onClick={() => {
                  this.addComment("Admin", this.state.newComment, "https://www.w3schools.com/howto/img_avatar.png");
                }}
              className="sendButton" sx={{"fontSize": "25px"}}/>
            </div>
        </div>
    );
  }
